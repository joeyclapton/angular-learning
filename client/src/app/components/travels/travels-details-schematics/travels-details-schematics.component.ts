...
import { TravelsDetailsSchematicsDataSource, TravelsDetailsSchematicsItem } from './travels-details-schematics-datasource';
...
export class TravelsDetailsSchematicsComponent implements AfterViewInit {
  ...
  @ViewChild(MatTable) table!: MatTable<TravelsDetailsSchematicsItem>;
